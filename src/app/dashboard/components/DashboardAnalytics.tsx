...
import TransactionBarChart from '@/components/charts/transactions-chart';
    ...
    <>
      ...
      <div className="flex w-full flex-col gap-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 w-full gap-4">
          <Card className="gap-2 border-none bg-gradient-to-br from-primary to-primary-400 shadow-lg shadow-primary-300/50">
            <Chip
              classNames={{
          ...
          <SimpleStats
            ...
            smallFigure={formatCurrency(allTransactions?.value || 0)}
        ...
        <div className="grid w-full grid-cols-1 md:grid-cols-2 lg:grid-cols-7 gap-4">
          ...
          <TransactionBarChart data={monthlyTransactionRecords} />
        </div>
      </div>
    </>
  );
