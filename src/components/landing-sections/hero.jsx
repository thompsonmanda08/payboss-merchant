...
export function Hero() {
  return (
    <div className="gap-5 pb-16 container pt-20 text-center sm:h-screen lg:pt-32">
      <div className="pt-8">
        <h1 className="mx-auto max-w-4xl bg-clip-text font-display text-5xl font-medium tracking-tight text-foreground/90 sm:text-7xl">
          ...
          <span className="relative whitespace-nowrap bg-gradient-to-br from-primary to-primary-light bg-clip-text text-primary">
            ...
            <span className="relative">Financial Needs</span>
          </span>{" "}
          for your business.
        </h1>
        <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-foreground/70">
          PayBoss offers advanced tools to help businesses manage their
          financial inflows and outflows efficiently, streamlining operations
          for all businesses.
        </p>
      ...
      <FrameContainer
        className={"mx-auto mt-10 hidden sm:block"}
